...
const MIME_TYPE = 'application/calculation';

/**
 * A Phosphor widget for rendering CJSON
 */
export class CalculationMonitorWidget extends Widget {
  constructor(options) {
    super();
...
export class CalculationMonitorOutputRenderer {
  /**
   ...
   */
  render(options) {
    return new CalculationMonitorWidget(options);
  }
}
